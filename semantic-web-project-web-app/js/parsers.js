...
License: MIT
*/
/* CSV Parser taken from: https://www.papaparse.com/ */
...
function parser() {
    ...
    if (fileFormat === "csv") {
        ...
        var delimiter = document.createElement('input');
        delimiter.setAttribute('type', 'hidden');
        delimiter.setAttribute('id', 'delimiter');
        delimiter.setAttribute('name', 'delimiter');
        delimiter.setAttribute('value', data.meta.delimiter);
